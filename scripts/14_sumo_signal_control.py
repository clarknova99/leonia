...
::
    ...
    venv/bin/python scripts/14_sumo_signal_control.py --demand peak_am_slice
    venv/bin/python scripts/14_sumo_signal_control.py \\
        --demand bridge_od_weekday_24h --intersections all
    venv/bin/python scripts/14_sumo_signal_control.py \\
        --demand peak_am_slice --baseline-run data/processed/sumo/runs/<ts>_peak_am_slice
